...
if("TRUE" STREQUAL "TRUE")
  set(teleop_twist_keyboard_SOURCE_PREFIX /home/robot/catkin_ws_base/src/teleop_twist_keyboard)
  set(teleop_twist_keyboard_DEVEL_PREFIX /home/robot/catkin_ws_base/devel)
  ...
  set(teleop_twist_keyboard_INSTALL_PREFIX /home/robot/catkin_ws_base/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
      endif()
    else()
      message(FATAL_ERROR "Project 'teleop_twist_keyboard' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/robot/catkin_ws_base/src/teleop_twist_keyboard/${idir}'.  Ask the maintainer 'Austin Hendrix <namniart@gmail.com>' to fix it.")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${teleop_twist_keyboard_dep}_FOUND)
      find_package(${teleop_twist_keyboard_dep} REQUIRED)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${teleop_twist_keyboard_dep} REQUIRED ${depend_list})
  endif()
